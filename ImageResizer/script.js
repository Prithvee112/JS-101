document.addEventListener("DOMContentLoaded", () => {
    ...
    let perdimension=document.getElementById("percentage-dimesions");
    let pxheight=document.getElementById("pixel-height-dimesions");
        ...
        resizeBtn.addEventListener("click",()=>{
            ...
            if(rUnit.value==="percentage"){
                ...
                if(isNaN(percentage)||percentage<1||percentage>100){
                    alert(`Please neter a valid percentage(1-100).`);
                    return;
                }
            ...
            imageObj.onload=()=>{
                ...
                let resizedDataUrl=canvas.toDataURL("image/jpg",imageQuality);
